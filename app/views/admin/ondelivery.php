    ...
    <div class="container-fluid mt-4">
        <div class="row p-3 py-3">
            <div class="bg-dark rounded mb-4">
                <h3 class="fw-bolder text-white mb-0 p-3 shadow-lg">On Delivery Orders</h3>
            </div>
    ...
    <div class="modal fade" id="orderDetails" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <form action="<?= site_url('Admin/Delivered/') ?>" method="POST">
                                        ...
                                        <div class="card border-0 mb-3 mt-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="email" name="email" placeholder="Username" aria-describedby="validationTooltipUsernamePrepend" disabled>
                                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="delivered">&nbspDelivered&nbsp</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    for (var i = tableHeaderRowCount; i < rowCount; i++) {
      ...
      function (data, status, xhr) { 
        ...
        for(let x in data["cart"]) {
            $(table).find('tbody').append("<tr><td>"+ data["cart"][x]["prod_name"]+"</td><td class='text-center'>"+ data["cart"][x]["quantity"]+"</td> </tr>");
        }
