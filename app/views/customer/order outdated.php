                        ...
                        <div class="header__top__right">
                            <div class="header__top__right__language">
                                ...
                                <?php if($this->session->has_userdata('username')){
                                    ...
                                    <ul>
                                        <li><a  href="'.site_url("Account/Login").'">Logout</a></li>
                                    </ul>';
                                } else{
                                    echo  '<a style = "text-decoration: none;" href="'.site_url("Account/Login").'"> Login</a>';
                                }
                                ?> </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><H3 class="fw-bold">Online Palengke</H3></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="./shop-grid.html">Orders</a></li>
                            <li><a href="#">Recipes</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./shop-details.html">Shop Details</a></li>
                                    <li><a href="./shoping-cart.html">Shoping Cart</a></li>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="<?=site_url('Customer/Cart');?>"><i class="fa fa-shopping-bag"></i> <span><?=sizeof($data['cart']);?></span></a></li>
                        </ul>
                ...
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table>
                            ...
                            <?php $total=0; foreach ($data['order'] as $order){ 
                                ?>
                                <tr>
                                    ...
                                    <span><?php if($order['trans_status']=='P'){echo 'Pending';}?></span>
                                    </td>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="<?=site_url('Customer/Home')?>" class="primary-btn cart-btn">CONTINUE SHOPPING</a>
                    </div>
                </div>
