                        ...
                        <?php foreach($data['category'] as $cat){ ?>
                            <div class="col-lg-3">
                                <div class="categories__item set-bg" data-setbg="<?=BASE_URL . PUBLIC_DIR?>/images/customer/category/<?=$cat['category'];?>    ">
                                    <h5><a class=" primary-btn" href="<?=site_url('Customer/Search/'.$cat['cat_id'])?>"><?=$cat['category'];?></a></h5>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2><?php if( $data['product']) echo 'Search result for "<i>'. $data['search'].'</i>"'; else echo 'No Result for "<i>'. $data['search'].'</i> "';?></h2>
                    </div>
                </div>
            </div>
